...
export default function LandPropertyCard({
  ...
  images = [
    ...
    "https://images.unsplash.com/photo-1628624747186-a941c476b7ef?w=300&h=300&fit=crop",
    "https://images.unsplash.com/photo-1628744448840-55bdb2497bd4?w=300&h=300&fit=crop",
    "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=300&h=300&fit=crop",
    "https://images.unsplash.com/photo-1628624747186-a941c476b7ef?w=300&h=300&fit=crop",
    "https://images.unsplash.com/photo-1628744448840-55bdb2497bd4?w=300&h=300&fit=crop",
  ],
  ...
  return (
    <Card
      className="w-full max-w-[350px] mx-auto overflow-hidden cursor-pointer shadow-none border-none"
            ...
            {specificities.map((spec, index) => {
              ...
              return (
                <span key={index} className="flex items-center font-medium">
                  <IconComponent className="h-4 w-4 mr-1 text-primary flex-shrink-0" />
                  <span className="text-primary truncate">{spec.value}</span>
                </span>
              );
            })}
          </div>
